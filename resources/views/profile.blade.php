...
<div class="py-14">
    ...
    <section class="">
        <div class="m-3 lg:m-24 flex flex-col  lg:flex-row  gap-14">
            <div class="flex-2">
                <iframe
    ...
    <section>
        <div class="m-3 mt-10 lg:m-24 flex flex-col lg:flex-row  gap-14">
            <div class="flex-2 space-y-5 ">
                <h3 class="text-4xl font-bold text-center lg:text-start text-primary">
                    Sarana dan Prasarana
                    <hr class="my-2 border-t-4 border-primary w-24 lg:mx-0 mx-auto">
                </h3>
            ...
            <div class="flex-2">
                ...
                <div>
                    <img src="{{ asset('assets/peta_mangalli.png') }}" alt="Peta Mangalli"
